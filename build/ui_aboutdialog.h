...
"Copyright &copy; 2011-YYYY The Technocoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Technocoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Technocoin</b> version", 0));
